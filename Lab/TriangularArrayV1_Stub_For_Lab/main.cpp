 ...
 * Created on February 23rd, 2021, 12:15 pM
...
int**fillAry(int);       //Randomly fill a triangular array
void prntAry(int **,int);//Print a triangular array
...
int main(int argc, char** argv) {
    ...
    cin>>rowSize;
    trangl=fillAry(rowSize);//Dynamic triangular array

    //Output Located Here
    cout<<"The Triangular Array"<<endl;
    prntAry(trangl,rowSize);

    //Deallocate the array
    destroy(trangl,rowSize);
