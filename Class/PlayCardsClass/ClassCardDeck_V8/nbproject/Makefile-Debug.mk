...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/classcarddeck_v8.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/classcarddeck_v8.exe: ${OBJECTFILES}
